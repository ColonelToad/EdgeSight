...
**Shift in Focus:**
The original research question has been refocused into a dedicated quantitative/HFT project (Metis). Maintaining two similar projects with overlapping themes would dilute effort. EdgeSight served its purpose as an exploration vehicle—time to commit to the primary thesis.
...
This project was a sandbox for learning. I wanted to better understand Go and how it works in a more meaningful way than just basic code snippets allow. The patterns explored here will inform future work, particularly in quantitative finance where semantic search over market events could provide edge in signal generation.
